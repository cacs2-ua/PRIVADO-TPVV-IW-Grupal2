...
ALTER TABLE ONLY public.recursos DROP CONSTRAINT fk5t0dyj6s6s3fkwh04p3x9jtre;
...
--
-- Name: recursos; Type: TABLE; Schema: public; Owner: mads
--
...
ALTER TABLE public.recursos OWNER TO mads;

--
-- Name: recursos_id_seq; Type: SEQUENCE; Schema: public; Owner: mads
--
...
ALTER TABLE public.recursos_id_seq OWNER TO mads;

--
-- Name: recursos_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mads
--
...
--
-- Name: recursos id; Type: DEFAULT; Schema: public; Owner: mads
--
...
COPY public.equipos (id, nombre, tipo) FROM stdin;
2	equipo 7	Desarrollo
3	frontendMakers	Diseño
\.


--
-- Data for Name: recursos; Type: TABLE DATA; Schema: public; Owner: mads
--

COPY public.recursos (id, nombre, usuario_id) FROM stdin;
\.
...
COPY public.tareas (id, hours, titulo, usuario_id) FROM stdin;
1	0	terminar esta practica	3
\.
...
COPY public.usuarios (id, admin, blocked, email, fecha_nacimiento, nombre, password, promedio_tareas) FROM stdin;
1	t	f	a@a.com	\N	a	a	0
2	f	f	user@ua	2001-01-29	user	123	0
3	f	f	prod@funcionandoº	2024-11-29	prod	prod	0
\.
...
--
-- Name: recursos_id_seq; Type: SEQUENCE SET; Schema: public; Owner: mads
--
...
--
-- Name: recursos recursos_pkey; Type: CONSTRAINT; Schema: public; Owner: mads
--
...
--
-- Name: recursos fk5t0dyj6s6s3fkwh04p3x9jtre; Type: FK CONSTRAINT; Schema: public; Owner: mads
--

ALTER TABLE ONLY public.recursos
    ADD CONSTRAINT fk5t0dyj6s6s3fkwh04p3x9jtre FOREIGN KEY (usuario_id) REFERENCES public.usuarios(id);
